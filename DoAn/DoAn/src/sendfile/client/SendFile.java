...
public class SendFile extends javax.swing.JFrame {
                ...
                while(!Thread.currentThread().isInterrupted()){
                    ...
                    switch(cmd){
                        ...
                        case "CMD_SENDFILEERROR":
                            ...
                            JOptionPane.showMessageDialog(SendFile.this, emsg,"Eror", JOptionPane.ERROR_MESSAGE);
                            form.updateAttachment(false);
    ...
    private void btnSendFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendFileActionPerformed
        ...
        if((sendTo.length() > 0) && (file.length() > 0)){
            ...
            JOptionPane.showMessageDialog(this, "Not to empty.!","Error", JOptionPane.ERROR_MESSAGE);
        }
